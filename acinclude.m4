...
AC_ARG_ENABLE(drivers,
	...
	[                    parallax,picolcd,pyramid,rawserial,sdeclcd,sed1330,sed1520,]
...
allDrivers=[bayrad,CFontz,CFontzPacket,curses,CwLnx,ea65,EyeboxOne,g15,glcd,glcdlib,glk,hd44780,i2500vfd,icp_a106,imon,imonlcd,IOWarrior,irman,irtrans,joy,lb216,lcdm001,lcterm,lirc,lis,MD8800,mdm166a,ms6931,mtc_s16209x,MtxOrb,mx5000,NoritakeVFD,parallax,parallax,picolcd,pyramid,sdeclcd,sed1330,sed1520,serialPOS,serialVFD,shuttleVFD,sli,stv5730,SureElec,svga,t6963,text,tyan,ula200,vlsys_m428,xosd,rawserial]
...
dnl			else
		...
		rawserial)
			...
			;;
		parallax)
			DRIVERS="$DRIVERS parallax${SO}"
			actdrivers=["$actdrivers parallax"]
			;;
		picolcd)
			if test "$enable_libusb" = yes ; then
